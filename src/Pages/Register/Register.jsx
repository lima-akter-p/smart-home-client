        ...
        <div className="hero bg-base-200 min-h-screen">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                    <form onSubmit={handleRegister} className="card-body w-100 bg-amber-200 rounded-xl">
                        <h1 className=" text-violet-600 text-4xl text-center font-bold">Hello,Welcome!</h1>
                        <fieldset className="fieldset">
                            ...
                            {/* password */}
                              <div className='relative'>
                                ...
                                <input type={showpassword?'text':'password'} className="input w-full" name="password" placeholder="Password" required />
                                <button 
                            ...
                            <button type="submit" className="btn bg-violet-700 mt-4 text-white hover:bg-blue-900">Sign Up</button>



                            <p className=' mt-2 text-sm font-bold text-center'>Already have an account? {" "}
                                <Link className='text-blue-900' to="/auth/login"> <br></br>
                                    <button className='mt-2 text-white btn bg-violet-600 hover:bg-blue-900'> Sign In</button>
                                </Link>
                            </p>
                        </fieldset>
